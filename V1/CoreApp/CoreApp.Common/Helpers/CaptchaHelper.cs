...
namespace CoreApp.Common.Helpers
{
    ...
    {
        private const string _letters = "2346789ABCDEFGHJKLMNPRTUVWXYZ";
        private const string _sessionKey = "CaptchaCode";
        ...
        {
            var isValid = userInputCaptcha == context.Session.GetString(_sessionKey) && userInputCaptcha != null;
