...
namespace CoreApp.EntityFramework.Migrations
{
    ...
    [Migration("20210118045405_update-lenghtentity")]
    partial class updatelenghtentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoLanguage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoPolicy", b =>
                {
                    ...
                    b.Property<int>("numberOfDueDate");
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoPunishment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoReservationBook", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpectedDay")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBook", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoAuthor", "Author")
                        .WithMany("DoBooks")
                    ...
                    b.HasOne("CoreApp.EntityFramework.Models.DoLanguage", "Language")
                        .WithMany("DoBooks")
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBookItem", b =>
                {
                    ...
                    b.HasOne("CoreApp.EntityFramework.Models.DoBookLending", "BookLending")
                        .WithMany("DoBookItems")
                    ...
                    b.HasOne("CoreApp.EntityFramework.Models.DoStatus", "Status")
                        .WithMany("DoBookItems")
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBookLending", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoBookItem", "BookItem")
                        .WithMany("DoBookLendings")
                        .HasForeignKey("BookItemId")
                        .HasConstraintName("FK_DoBookLendings_BookItems")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("CoreApp.EntityFramework.Models.DoMember", "Member")
                        .WithMany("DoBookLendings")
