...
namespace CoreApp.EntityFramework.Migrations
{
    ...
    [Migration("20201207123906_update-rolemodule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.CoreRoleModulePermission", b =>
                {
                    ...
                    b.Property<Guid?>("DoAuthorID");

                    b.HasKey("RoleId", "ModuleId", "PermissionId");

                    b.HasIndex("DoAuthorID");
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoAuthor", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBook", b =>
                {
                    ...
                    b.Property<long?>("DoCatalogID");

                    b.Property<long?>("DoPublishierID");
                    ...
                    b.HasIndex("DoCatalogID");

                    b.HasIndex("DoPublishierID");
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBookItem", b =>
                {
                    ...
                    b.Property<long?>("DoBookId");

                    b.Property<long?>("DoRackID");
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoLibraryCard", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long?>("DoMemberID");

                    b.Property<DateTime>("IssuedAt");

                    b.HasKey("ID");

                    b.HasIndex("DoMemberID");

                    b.ToTable("DoLibraryCards");
                });
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoMember", b =>
                {
                    ...
                    b.Property<long?>("DoMemberGroupID");
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.CoreRoleModulePermission", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoAuthor")
                        .WithMany("CoreRoleModulePermissions")
                        .HasForeignKey("DoAuthorID");
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBook", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoCatalog")
                        .WithMany("BookId")
                        .HasForeignKey("DoCatalogID");

                    b.HasOne("CoreApp.EntityFramework.Models.DoPublishier")
                        .WithMany("BookId")
                        .HasForeignKey("DoPublishierID");
                });

            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBookItem", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoBook")
                        .WithMany("BookItemId")
                        .HasForeignKey("DoBookId");

                    b.HasOne("CoreApp.EntityFramework.Models.DoRack")
                        .WithMany("BookItemId")
                        .HasForeignKey("DoRackID");
                });

            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoBookLending", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoBookItem")
                        .WithMany("BookLendingId")
                        .HasForeignKey("DoBookItemId");
                });
            ...
            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoLibraryCard", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoMember")
                        .WithMany("LibraryCardId")
                        .HasForeignKey("DoMemberID");
                });

            modelBuilder.Entity("CoreApp.EntityFramework.Models.DoMember", b =>
                {
                    b.HasOne("CoreApp.EntityFramework.Models.DoMemberGroup")
                        .WithMany("MemberId")
                        .HasForeignKey("DoMemberGroupID");
                });
