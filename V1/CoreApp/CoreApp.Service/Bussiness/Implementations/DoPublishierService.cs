...
{
    public sealed class DoPublishierService : BaseService<DoPublishier>, IPublishierService
    {
        #region Fields
        private readonly IPublishierDm _dm;
        #endregion

        #region Contructors
        public DoPublishierService(IPublishierDm dm, IUserManager userManager) : base(dm, userManager)
        {
            _dm = dm;
        }
        #endregion
        #region validate
        public override string[] ValidateBeForSave(DoPublishier entity)
        {
            var resultMessages = new List<string>();
            if (_dm.CheckingForName(entity) != null)
            {
                resultMessages.Add("Nhà xuất bản đã tồn tại");
            }

            return resultMessages.ToArray();
        }
        public override string[] ValidateBeForUpdate(DoPublishier entity)
        {
            var resultMessages = new List<string>();
        ...
        #endregion
        #region Method
        public override ResultModel Insert(DoPublishier entity)
        {
        ...
        public override ResultModel Update(DoPublishier entity)
        {
            var resultModel = new ResultModel();
