...
{
    public sealed class DoFormatService : BaseService<DoFormat>, IFormatService
    {
        #region Fields
        private readonly IFormatDm _dm;
        #endregion

        #region Contructors
        public DoFormatService(IFormatDm dm, IUserManager userManager) : base(dm, userManager)
        {
            _dm = dm;
        }
        #endregion
        #region validate
        public override string[] ValidateBeForSave(DoFormat entity)
        {
            var resultMessages = new List<string>();
            if (_dm.CheckingForName(entity) != null)
            {
                resultMessages.Add("Định dạng đã tồn tại");
            }

            return resultMessages.ToArray();
        }
        public override string[] ValidateBeForUpdate(DoFormat entity)
        {
            var resultMessages = new List<string>();
        ...
        #endregion
        #region
        public override ResultModel Insert(DoFormat entity)
        {
        ...
        public override ResultModel Update(DoFormat entity)
        {
            var resultModel = new ResultModel();
