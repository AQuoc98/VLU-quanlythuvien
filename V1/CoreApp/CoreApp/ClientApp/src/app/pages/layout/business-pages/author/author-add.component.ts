...
export class AuthorAddComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    private coreAuthorApiServices: CoreAuthorApiServices,
  ...
  private saveData() {
    ...
    if (this.fControls.id.value == Guid.empty) {
      // Add
      this.coreAuthorApiServices.insert(this.dataModel).subscribe((res) => this.saveDataCompleted(res));
    } else {
      // Update
      this.coreAuthorApiServices.update(this.dataModel).subscribe((res) => this.saveDataCompletedEdit(res))
    }
  }
  ...
  private loadDataEdit(id: string) {
    this.isEdit = true;
    this.coreAuthorApiServices.getById(id).subscribe((res) => {
